...
const Help = () => {
    return (
        <div className=''>
            ...
            <div className="lg:flex lg:h-80 text-center gap-3">
                <div className="bg-yellow-600 py-5 lg:pt-24 text-white">
                ...
                <div className="bg-green-600 py-5 lg:pt-24 text-white">
